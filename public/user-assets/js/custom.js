document.addEventListener("DOMContentLoaded", () => {
    ...
    counter("Partners", 0, 5, 3000);
    counter("Projects", 0, 100, 2500);
    counter("Clients", 0, 350, 3000);
   });
                ...
                return (
                    $.ajax({
                        ...
                        success: function (t) {
                            ...
                            n &&
                                a &&
                                (e.find(".messages").html(i), e[0].reset()),
                                setTimeout(function () {
                ...
                return {
                    ...
                    ajaxSlider: function (t, n) {
                        let a = this,
                            ...
                            o = e(
                                '.dsn-slider .slide-item[data-dsn-id="' +
                                    i +
                                    '"] .cover-bg'
                            ).first(),
                            s = n;
            ...
            (function () {
                ...
                n.each(function (t) {
                    ...
                    n.on("mouseenter", function () {
                        ...
                        if (
                            t.hasClass("dsn-active") ||
                            o.hasClass("dsn-ajax-effect")
                        )
                            return;
                        n.removeClass("dsn-active"),
                            e(this).addClass("dsn-active");
                ...
                return {
                    initSlider: function () {
                        ...
                        n.each(function (t) {
                            ...
                            n.attr("data-dsn-id", t),
                                0 === t &&
                                    n.addClass("dsn-active dsn-active-cat"),
                                a.append(n);
                    ...
                    slideChange: function (a) {
                        ...
                        a.on("slideChange", function () {
                            ...
                            if (s === r) return;
                            t.find('[data-dsn="video"] video').each(
                                function () {
                                    this.pause();
                                }
                            );
                            ...
                            let c = t.find(
                                    '.dsn-slider-content [data-dsn-id="' +
                                        r +
                                        '"]'
                                ),
    ...
    function a() {
        ...
        return {
            ...
            getScrollbar: function (e) {
                return void 0 === e
                    ? t.get(a)
                    : t.get(document.querySelector(e));
            },
            ...
            sliderScroll: function () {
                t.init(
                    document.querySelector(
                        ".slider .main-slider .slider-nav-list"
                    ),
                    { damping: 0.05 }
                );
            },
            ...
            e(".site-header .custom-drop-down > a").on("click", function () {
                ...
                i.on("load", function () {
                    ...
                    (a = e(a)).attr("class", "nav__list"),
                        a
                            .find("li.custom-drop-down")
                            .attr("class", "nav__list-dropdown"),
            ...
            return {
                    ...
                    if (
                        ...
                        r.length > 0 &&
                            d.to(
                                r,
                                0.8,
                                { force3D: !0, bottom: "-10%", autoAlpha: 0 },
                                0
                            ),
                        d._totalDuration <= 0)
                    )
                ...
                parallaxImg: function () {
                    e('[data-dsn-grid="move-up"]').each(function () {
                        ...
                        let a = n.find("img:not(.hidden) , video"),
                            i = dsnGrid.getUndefinedVal(
                                n.data("dsn-triggerhook"),
                                1
                            ),
                ...
                moveSection: function () {
                    e('[data-dsn-grid="move-section"]').each(function () {
                        let n = e(this);
                        n.removeAttr("data-dsn-grid"),
                            n.addClass("dsn-move-section");
                        let a = dsnGrid.getUndefinedVal(
                                n.data("dsn-move"),
                                -100
                            ),
                            o = dsnGrid.getUndefinedVal(
                            ...
                            l = dsnGrid.getUndefinedVal(
                                n.data("dsn-duration"),
                                "150%"
                            );
                        if (
                            "tablet" === n.data("dsn-responsive") &&
                            i.width() < 992
                        )
                            return;
