                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="services-item">
                                        ...
                                        <p>Gain strategic insights and grow your company sustainably with our <br> business consultancy services.</p>
                                        <div class="link-custom">
                    ...
                    <section class="mb-100 container">
                        <div class="c-wapp">
                            ...
                            <div class="fz-20 secondline">
                                <span class="text-center hiring"">
                                    Tap into our deep industry knowledge, innovative techniques, and  meticulous attention <br> to detail to accelerate your online growth.
                                </span>
                            </div>
                            ...
                            <div class="work-container">
                                <div class="slick-slider">
                                    ...
                                    <div class="work-item slick-slide">
                                        <img class="has-top-bottom" src="{{asset('user-assets/img/project/project6/ads-app-project-feature-image.jpg')}}" alt="">
                                    ...
                                    <div class="work-item slick-slide">
                                        <img class="has-top-bottom" src="{{asset('user-assets/img/project/project6/tmt-project-feature-image.jpg')}}" alt="">
                                        <div class="item-border"></div>
                                        <div class="item-info">
                                            <a href="the-mental-talkies.html" data-dsn-grid="move-up" class="effect-ajax">
                                    ...
                                    <div class="work-item slick-slide">
                                        <img class="has-top-bottom" src="{{asset('user-assets/img/project/project6/bs-photography-featured-img.jpg')}}" alt="">
                                        <div class="item-border"></div>
                                        <div class="item-info">
                                            <a href="bsphotography-project.html" data-dsn-grid="move-up" class="effect-ajax">
                                    ...
                                    <div class="work-item slick-slide">
                                        <img class="has-top-bottom" src="{{asset('user-assets/img/project/project6/yosh-group-project-feature-image.jpg')}}"alt="">
                                        <div class="item-border"></div>
                                        <div class="item-info">
                                    ...
                                    <div class="work-item slick-slide">
                                        <img class="has-top-bottom" src="{{asset('user-assets/img/project/project6/grassland-featured-img.jpg')}}" alt="">
                                        <div class="item-border"></div>
                                        <div class="item-info">
                                            <a href="grasslanddesign-project.html" data-dsn-grid="move-up" class="effect-ajax">
                                    ...
                                    <div class="work-item slick-slide">
                                        <img class="has-top-bottom" src="{{asset('user-assets/img/project/project6/top-rathi-project-feature-image.jpg')}}" alt="">
                                        <div class="item-border"></div>
                                        <div class="item-info">
                ...
                <div class="container">
                    ...
                    <div class="wapper-client1 wapper-client">
                        ...
                        <div class="col-3 logo-box logo-box1">
                            ...
                            <img src="assets/img/logo/publicize-client.png" alt="">
